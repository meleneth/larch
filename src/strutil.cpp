...
void Larch::Tokenize(const std::string& str, std::vector<std::string>& tokens,
...
std::string Larch::replace_all_substrings(std::string from_me,
                                          std::string take_me,
                                          std::string for_me) {
...
std::string Larch::replace_substrings(std::string from_me, std::string take_me,
                                      std::string for_me) {
  std::string result;
